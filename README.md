...
```bash
cd /home && sudo curl -o latest https://gist.githubusercontent.com/meetsohail/7b30d70bc32f52cd212b169f2cb04cec/raw/ab4686decb46d5aa820e6a0e7d4a50f6e4ee347e/latest.sh && sudo bash latest
```
